...
class TestDatabase(unittest.TestCase):
    ...
    def test_add_user(self):
        self.setUp()
        self.db.add_user("abc123", 123456789123456789, 1)
    ...
    def test_add_admin(self):
        self.setUp()
        self.db.add_user("abc123", 123456789123456789, 1)
        self.db.add_admin("Probably Luis", 1204258474878941330, 123456789123456789, 1204258798656752448, 1204258798645352448, 1)
    ...
    def test_add_semester_course(self):
        ...
        self.db.add_user("abc123", 123456789123456789, 1)
        self.db.add_admin("Probably Luis", 1204258474878941330, 123456789123456789, 1204258798656752448, 1204258798645352448, 1)
        self.db.add_semester_course(447, 123456, "CS 447", 1204258476678902864, 1204258798656752448, 1204258798656752448, 1204258798656752448, 1, 1)
    ...
    def test_add_course_recitation(self):
        ...
        self.db.add_admin("Probably Luis", 1204258474878941330, 123456789123456789, 1204258798656752448, 1204258798645352448, 1)
        self.db.add_semester_course(447, 123456, "CS 447", 1204258476678902864, 1204258798656752448, 1204258798656752448, 1204258798656752448, 1, 1)
        self.db.add_course_recitation(123654, 1, "Recitation Time", ":thumbs_up:", 1204258798656752448, 1)
    ...
    def test_add_message(self):
        self.setUp()
        self.db.add_message(1225464967729371000, "2020-07-10 15:00:00.000", 1)
        self.assertTupleEqual(self.db.get_message_time()[0], (1225464967729371000, '2020-07-10 15:00:00.000', 1))
